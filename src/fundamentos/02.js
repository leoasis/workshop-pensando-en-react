...
//    una prop `artist` que es el objeto definido abajo.
// 2. El componente `ArtistImage` que engloba el div con clase "artistImage". Recibe
//    como props el tamaño de la imagen (un número definido debajo) y la url de la
//    imagen del artista.
// 3. El componente `SpotifyLogo` que encierra el elemento imagen con el logo de
//    Spotify. Recibe como prop el tamaño del logo (un número definido debajo).
//
